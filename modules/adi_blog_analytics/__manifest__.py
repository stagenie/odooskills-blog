{
    ...
    'version': '19.0.1.0.0',
    'category': 'Marketing',
    'summary': "Tableau de bord backend : inscrits newsletter, vues d'articles, top articles, filtres temps",
    'description': """
Module 100% XML (zéro Python métier). Ajoute une application "Blog Analytics" avec :
- Inscrits newsletter (par jour, par pays)
- Vues d'articles blog (par jour)
- Top articles (ordre visits DESC)
- Filtres temps unifiés : Aujourd'hui / Ce mois / Mois dernier / 7j / 30j

S'appuie exclusivement sur les modèles natifs Odoo (mailing.contact, website.track, blog.post).
